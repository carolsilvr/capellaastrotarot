...
export interface FileRouteTypes {
  ...
  fullPaths: '/' | '/agendar' | '/blog' | '/blog/$slug' | '/servicos/$slug' | '/auth/login' | '/cliente' | '/admin' | '/cms' | '/cms/login'
  fileRoutesByTo: FileRoutesByTo
  to: '/' | '/agendar' | '/blog' | '/blog/$slug' | '/servicos/$slug' | '/auth/login' | '/cliente' | '/admin' | '/cms' | '/cms/login'
  id:
    | '__root__'
    | '/'
    | '/agendar'
